...
We have run a comprehensive amount of simulations in order to measure parameter sensitivity, understand common scenarios, and validate our simulation. Each simulation run plays an important part in helping us analyze the behavioral effect on COVID-19.
\subsection{Simulation Runs}
All the simulation runs used for analysis have been organized here in a concise manner. This conciseness means that we have only included the metrics for each run instead of its plots which would have taken up too much space. Throughout these runs we have manipulated the $spay$ behavioral parameters and the initial symptomatic population $N\_Y0$ parameter. If certain parameters are not listed for a run than they take up their default values. Also, each of these runs were executed in a virtual python environment containing all the libraries listed in the implementation. Finally, for a more comprehensive summary
\begin{table}[!h]
	\centering
	\begin{tabular}{| l | l |}
		\hline
...
\begin{tabular}{|l | l | l |}
	...
	\hline
	N\_S0     & $N\_S0$ Parameter Sensitivity                              & N\_S0=3500                  \\
	\hline
	realistic & Realistic Behavior Change Scenario                         & s=0.60 p=0.60 a=0.60 y=0.25 \\
	\hline
	orderly   & Orderly Population Behavior Change Scenario                & s=0.50 p=0.50 a=0.50 y=0.25 \\
	\hline
	skeptic   & Skeptic Population Behavior Change Scenario                & s=0.70 p=0.70 a=0.70 y=0.35 \\
	\hline
	testing   & Accurate Self-Testing Behavior Change Scenario             & s=0.60 p=0.30 a=0.30 y=0.25 \\
	\hline
	skep_test & Mixed Skeptic Self-Testing Behavior Change Scenario        & s=0.70 p=0.40 a=0.40 y=0.25 \\
	\hline
	default   & No Change Face Validation                                  & All Defaults                \\
	\hline
	realistic & Realistic Face Validation                                  & s=0.60 p=0.60 a=0.60 y=0.25 \\
	\hline
	isolation & Isolation Face Validation                                  & s=1.00 p=0.00 a=0.00 y=0.00 \\
	\hline
	...
	\hline
	infecpop  & Increased Initial Infectious Population Extreme Validation & N\_Y0=500 \\
	\hline\hline
\end{tabular}

\subsubsection{Sensitivity Runs}
In total five runs were used to measure the sensitivity of our $spay$ and $N\_S0$ parameters. Specifically, the first run is the default run the later parameter runs were measured against. These runs will help us understand which parameter has the largest impact on our results.
\begin{table}[!h]
	\centering
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		\hline
		Peak Time       & 77473.95 & 4518.47 & 68236.86 & 86511.22 & [76176.78, 78771.12] \\
		\hline
		Peak Infections & 1631.86  & 62.14    & 1498.00  & 1770.00   & [1614.02, 1649.70]   \\
		\hline
	\end{tabular}
...
\begin{table}[!h]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		\hline
		Peak Time       & 79431.68 & 5351.22 & 70527.98 & 95599.05 & [77895.44, 80967.92] \\
		\hline
		Peak Infections & 1331.52  & 53.91   & 1206.00  & 1424.00   & [1316.04, 1347.00]   \\
		\hline
	\end{tabular}
...
\begin{table}[!h]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		Metric          & Mean      & Std Dev  & Min      & Max       & Conf                   \\ [0.5ex]
		\hline\hline
		Attack Rate     & 0.88      & 0.01     & 0.86     & 0.90      & [0.88, 0.88]           \\
		\hline
		Peak Time       & 86511.72 & 6403.72 & 75863.07 & 108215.33 & [86551.72, 90228.50] \\
		\hline
		Peak Infections & 1412.14   & 54.98    & 1308.00   & 1569.00    & [1396.36, 1427.92]     \\
		\hline
	\end{tabular}
...
\begin{table}[!h]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		Attack Rate     & 0.88      & 0.01     & 0.86     & 0.90      & [0.88, 0.88]           \\
		\hline
		Peak Time       & 88584.59 & 6408.03 & 72494.95 & 102771.02 & [86744.96, 90424.22] \\
		\hline
		Peak Infections & 1398.20   & 58.09    & 1285.00  & 1545.00   & [1381.52, 1414.88]     \\
		\hline
	\end{tabular}
...
\begin{table}[!h]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		Metric          & Mean      & Std Dev & Min      & Max       & Conf                   \\ [0.5ex]
		\hline\hline
		Attack Rate     & 0.89      & 0.01    & 0.87     & 0.90      & [0.88, 0.89]           \\
		\hline
		Peak Time       & 90261.35 & 5426.53 & 76324.10 & 103593.88 & [88703.49, 91819.21] \\
		\hline
		Peak Infections & 1434.66   & 53.83   & 1309.00  & 1566.00   & [1419.20, 1450.12]     \\
		\hline
	\end{tabular}
...
\begin{table}[!h]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		Metric          & Mean      & Std Dev   & Min  & Max       & Conf                   \\ [0.5ex]
		\hline\hline
		Attack Rate     & 0.30      & 0.04      & 0.19 & 0.      & [0.17, 0.24]           \\
		\hline
...
\begin{table}[!h]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		Metric          & Mean      & Std Dev   & Min  & Max       & Conf                   \\ [0.5ex]
		\hline\hline
		Attack Rate     & 0.24      & 0.11      & 0.00 & 0.35      & [0.21, 0.27]           \\
		\hline
		Peak Time       & 248909.43 & 131228.58 & 0.00 & 574217.80 & [211236.04, 286582.81] \\
		\hline
		Peak Infections & 132.96    & 64.02     & 5.00 & 248.00    & [114.58, 151.33]       \\
		\hline
	\end{tabular}
